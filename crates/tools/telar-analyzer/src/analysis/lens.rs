//! `textDocument/codeLens`: a "▶ Preview" action over each `[preview "Name"]` header, wired to the `telar.preview` command the extension registers (→ `cargo telar preview`).
        ...
        .map(|preview| {
            ...
            CodeLens {
                ...
                command: Some(Command {
                    ...
                    command: "telar.preview".to_string(),
                    arguments: Some(vec![
