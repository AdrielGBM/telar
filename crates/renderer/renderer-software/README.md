# telar-renderer-software

CPU rasterizer for Telar, built on tiny-skia, with software surface presentation.
...
- API documentation: <https://docs.rs/telar-renderer-software>
