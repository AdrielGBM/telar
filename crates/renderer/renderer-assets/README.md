# telar-renderer-assets

Decodes SVG and raster assets into Telar's drawing vocabulary, at runtime or baked at build time.
...
- API documentation: <https://docs.rs/telar-renderer-assets>
