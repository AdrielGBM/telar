...
///
/// CI sets it on the leg that installs lavapipe, so a suite that quietly stopped covering the GPU reads as red there rather than as fifteen passing tests that never ran. Everywhere else the absence is a real answer and the test skips.
