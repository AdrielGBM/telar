# telar-renderer-record

A Telar render backend that draws nothing and records what it was asked to draw, for tests without a GPU or a rasteriser.
...
- API documentation: <https://docs.rs/telar-renderer-record>
