# telar-renderer-cache

One byte-budgeted cache with admission and idle eviction, shared by every Telar renderer backend.
...
- API documentation: <https://docs.rs/telar-renderer-cache>
