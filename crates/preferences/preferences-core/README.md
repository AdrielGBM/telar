...
- API documentation: <https://docs.rs/telar-preferences-core>
- The framework, and where to start: <https://github.com/AdrielGBM/telar>
- What each target reports, and when: [`docs/system-preferences.md`](https://github.com/AdrielGBM/telar/blob/main/docs/system-preferences.md)
