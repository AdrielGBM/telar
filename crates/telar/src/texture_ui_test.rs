...
//!
//! The mirror of `renderer-hardware/src/app_owned_texture_test.rs`, which proves the other direction. Its own test binary because the shared device is a process-wide `OnceLock` and this one wants to open it.
