...
pub struct AppConfig {
    ...
    /// The family this application's unstyled text shapes in — a shell's theme font. `None` keeps the platform's own. Loading a face with `font_paths`/`font_data` does not choose it; this does.
    ///
