...
impl SandboxTheme {
    ...
    pub fn midnight() -> Self {
        Self {
            ...
            muted: c("#8b93a7"),
            primary: c("#5b7cfa"),
            // Dark, in a dark theme, and not a mistake: this theme's accents are the bright end of their hues, so what sits *on* them is the far end from them. White read 3.68:1 on the primary and 1.83:1 on the warning; this clears 4.5:1 on all five fills the token is used over.
            on_primary: c("#0e1017"),
            success: c("#34c98a"),
            danger: c("#f26d6f"),
            warning: c("#f2b53c"),
