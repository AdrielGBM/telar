...
col gap:22
    col gap:2
        text "▲ rsx" font_size:20 color:ink
        text "Feature gallery" font_size:12 color:muted
    col gap:8
        text "THEME" font_size:11 color:muted
        col gap:6
            row gap:6 wrap
            ...
            text "Active · {$theme_name}" font_size:12 color:muted
