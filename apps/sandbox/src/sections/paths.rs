...
use rsx::{
    Canvas, Color, Component, FillRule, LayoutError, LineCap, LineJoin, Paint, Path, PathData,
    PathStyle, Point, Rect, RenderNode, Shadow, ShapeStyle, Stroke, TextStyle, WidgetCtx,
};
...
pub fn paths_section(ctx: &mut WidgetCtx) -> Result<Canvas, LayoutError> {
    Canvas::with_intrinsic_height(ctx, 660.0, |rect| {
        ...
        draw_section_header(&mut children, w, "Paths");
