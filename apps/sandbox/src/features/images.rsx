        ...
        card
            row gap:20 align:end wrap
                col @swatch
                    ...
                    text "Linear" font_size:12 color:muted
                col @swatch
                    img src:checker raster:nearest width:120 height:120
                    text "Nearest" font_size:12 color:muted
        ...
        card
            row gap:20 wrap align:start
                col @swatch
                    ...
                    text "contain (default)" font_size:12 color:muted
                col @swatch
                    img src:gradient fit:cover width:150 height:80
                    text "cover" font_size:12 color:muted
                col @swatch
                    img src:gradient fit:fill width:150 height:80
                    text "fill" font_size:12 color:muted
