...
col gap:20
    ...
    example title:"tabs — a bound index; swap panels with reactive ifs"
        card gap:10
            ...
            if $tab == 0
                text "Overview — what the product does." font_size:14 color:ink
            if $tab == 1
                text "Pricing — plans and limits." font_size:14 color:ink
            if $tab == 2
                text "Team — who is behind it." font_size:14 color:ink
    ...
    example title:"accordion — a collapsible section, open bound to a signal"
        card gap:10
            accordion title:"Shipping details" open:$open
                text "Ships in 2–3 business days. Free over $50." font_size:14 color:muted
            text "open · {$open}" font_size:13 color:muted
