    ...
    col gap:8
        ...
        card
            row gap:14 wrap
                ...
                box stroke:primary stroke_width:2 radius:10 width:150 height:70 align:center justify:center
                    text "stroke" size:13 color:primary
                box fill:surface_alt stroke:primary stroke_width:2 radius:10 width:150 height:70 align:center justify:center
