...
// `col gap:8 > text "…" size:13 color:ink > …children…` scaffold used across every feature section,
...
[view]
col gap:8
    text "{props.title}" size:13 color:ink
    children

[preview "Example"]
example title:"justify — distribute along the main axis"
    card gap:10
        text "The demo and its code snippet stack here." size:13 color:muted
